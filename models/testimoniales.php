...
class testimoniales extends ActiveRecord{
    ...
    public function validarTestimonial(){
        if(!$this->nombre)self::$alertas['error'][] = "nombre del testimonial es obligatorio";
        ...
        if(strlen($this->comentario)>416)self::$alertas['error'][] = 'Has excecido el limite de caracteres del comentario testimonial';
